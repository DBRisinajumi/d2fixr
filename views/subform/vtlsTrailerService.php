        ...
        <div class="span12">
            <div class="form-horizontal">
                ...
                array(
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtls_start_date') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtls_start_date')) != 'tooltip.vtls_start_date')?$t:'' ?>'>
                                <?php
                            $this->widget('zii.widgets.jui.CJuiDatePicker',
                         array(
                                 'model' => $model,
                                 'attribute' => 'vtls_start_date',
                    ...
                    ;
                            echo $form->error($model,'vtls_start_date')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtls_end_date') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtls_end_date')) != 'tooltip.vtls_end_date')?$t:'' ?>'>
                                <?php
                            $this->widget('zii.widgets.jui.CJuiDatePicker',
                         array(
                                 'model' => $model,
                                 'attribute' => 'vtls_end_date',
                                 'language' =>  strstr(Yii::app()->language.'_','_',true),
                                 'htmlOptions' => array('size' => 10),
                                 'options' => array(
                                     'showButtonPanel' => true,
                    ...
                    ;
                            echo $form->error($model,'vtls_end_date')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtls_price') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtls_price')) != 'tooltip.vtls_price')?$t:'' ?>'>
                                <?php
                            echo $form->textField($model, 'vtls_price', array('size' => 10, 'maxlength' => 10));
                            echo $form->error($model,'vtls_price')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtls_fcrn_id') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtls_fcrn_id')) != 'tooltip.vtls_fcrn_id')?$t:'' ?>'>
                                <?php
                            $this->widget(
                '\GtcRelation',
                array(
                    ...
                    'htmlOptions' => array(
                        'checkAll' => 'all'
                            ...
                            echo $form->error($model,'vtls_fcrn_id')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtls_deleted') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtls_deleted')) != 'tooltip.vtls_deleted')?$t:'' ?>'>
                                <?php
                            echo $form->textField($model, 'vtls_deleted');
                            echo $form->error($model,'vtls_deleted')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
