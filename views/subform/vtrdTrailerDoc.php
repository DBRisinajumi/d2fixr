        ...
        <div class="span12">
            <div class="form-horizontal">
                ...
                array(
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtrd_updated') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtrd_updated')) != 'tooltip.vtrd_updated')?$t:'' ?>'>
                                <?php
                            $this->widget('zii.widgets.jui.CJuiDatePicker',
                         array(
                                 'model' => $model,
                                 'attribute' => 'vtrd_updated',
                                 'language' =>  strstr(Yii::app()->language.'_','_',true),
                                 'htmlOptions' => array('size' => 10),
                                 'options' => array(
                                     'showButtonPanel' => true,
                    ...
                    ;
                            echo $form->error($model,'vtrd_updated')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtcd_fcrn_id') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtcd_fcrn_id')) != 'tooltip.vtcd_fcrn_id')?$t:'' ?>'>
                                <?php
                            $this->widget(
                '\GtcRelation',
                array(
                    ...
                    'htmlOptions' => array(
                        'checkAll' => 'all'
                            ...
                            echo $form->error($model,'vtcd_fcrn_id')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtcd_price') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtcd_price')) != 'tooltip.vtcd_price')?$t:'' ?>'>
                                <?php
                            echo $form->textField($model, 'vtcd_price', array('size' => 10, 'maxlength' => 10));
                            echo $form->error($model,'vtcd_price')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtrd_deleted') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtrd_deleted')) != 'tooltip.vtrd_deleted')?$t:'' ?>'>
                                <?php
                            echo $form->textField($model, 'vtrd_deleted');
                            echo $form->error($model,'vtrd_deleted')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
