...
abstract class BaseFdm2Dimension2 extends CActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                ...
                array('fdm2_ref_id, fdm2_fdm1_id, fdm2_code, fdm2_name, fdm2_hidden', 'default', 'setOnEmpty' => true, 'value' => null),
                array('fdm2_fret_id, fdm2_fdm1_id, fdm2_hidden', 'numerical', 'integerOnly' => true),
                array('fdm2_ref_id, fdm2_code', 'length', 'max' => 10),
                array('fdm2_name', 'length', 'max' => 50),
                array('fdm2_id, fdm2_fret_id, fdm2_ref_id, fdm2_fdm1_id, fdm2_code, fdm2_name, fdm2_hidden', 'safe', 'on' => 'search'),
            )
        );
    }
    ...
    {
        return (string) $this->fdm2_ref_id;
    }
