...
abstract class BaseFddaDimData extends CActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                ...
                array('fdda_amt, fdda_date_from, fdda_date_to', 'default', 'setOnEmpty' => true, 'value' => null),
                array('fdda_fret_id', 'numerical', 'integerOnly' => true),
                array('fdda_fixr_id, fdda_fdm2_id, fdda_fdm3_id, fdda_amt', 'length', 'max' => 10),
                array('fdda_date_from, fdda_date_to', 'safe'),
                array('fdda_id, fdda_fixr_id, fdda_fret_id, fdda_fdm2_id, fdda_fdm3_id, fdda_amt, fdda_date_from, fdda_date_to', 'safe', 'on' => 'search'),
            )
        );
    }
    ...
    {
        return (string) $this->fdda_fixr_id;
    }
