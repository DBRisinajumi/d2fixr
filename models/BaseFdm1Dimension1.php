 ...
 * @property string $fdm1_sys_ccmp_id
...
abstract class BaseFdm1Dimension1 extends CActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                ...
                array('fdm1_id, fdm1_sys_ccmp_id, fdm1_code, fdm1_name, fdm1_hidden', 'safe', 'on' => 'search'),
            )
        );
    }
    ...
    {
        return (string) $this->fdm1_sys_ccmp_id;
    }
    ...
    public function relations()
    {
        return array_merge(
            parent::relations(), array(
                ...
                'fdspDimensionSplits' => array(self::HAS_MANY, 'FdspDimensionSplit', 'fdsp_fdm1_id'),
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'fdm1_sys_ccmp_id' => Yii::t('D2fixrModule.model', 'Fdm1 Sys Ccmp'),
    ...
    public function searchCriteria($criteria = null)
    {
        ...
        $criteria->compare('t.fdm1_sys_ccmp_id', $this->fdm1_sys_ccmp_id, true);
