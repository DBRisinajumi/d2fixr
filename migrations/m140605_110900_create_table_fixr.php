	...
	public function up()
	{
		$this->execute("
                CREATE TABLE  IF NOT EXISTS `fixr_fiit_x_ref` (
                    ...
                    `fixr_position_fret_id` tinyint(3) unsigned DEFAULT NULL,
                    ...
                    CONSTRAINT `fixr_fiit_x_ref_ibfk_2` FOREIGN KEY (`fixr_position_fret_id`) REFERENCES `fret_ref_type` (`fret_id`),
